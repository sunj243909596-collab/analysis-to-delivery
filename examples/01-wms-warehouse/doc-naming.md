...
Claude 在阶段 2-9 产出文档时按本文件命名。当前示例用默认，所以文件名直接是 `01-业务需求文档 BRD.md` 等。

---

**生成时间**：2026-06-22
**关联模板**：[templates/project-config/doc-naming.md](../../templates/project-config/doc-naming.md)
**默认规范**：[skills/disciplines/doc-numbering/SKILL.md](../../skills/disciplines/doc-numbering/SKILL.md)
