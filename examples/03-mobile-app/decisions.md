# Decisions（ADR / 决策记录）— 移动 App 会员积分管理(v4.0.0)

> 项目:移动 App — 会员积分管理
> 版本:v4.0.0(2026-07,阶段 4-7 文档补齐;v4.0.0 起从 `config-used.md` 改名为 decisions.md)
...
| 2026-07-02 | v4.0.0 升级:新增 04/05/07 三文档 + PIPL/App Store/Google Play 合规清单 | 跟随 skill v4.0.0 阶段 4-7 补齐;涉及中国用户 + App 上架,需补合规 |
